...
public class SecurityFacadeTest {
    ...
    /**
     * @see SecurityFacade#updateProfile(f18a14c09s.pscpm.security.domain.User)
     */
    @Test
    ...
    /**
     * @see SecurityFacade#decryptPassword(f18a14c09s.pscpm.security.domain.PublicKeyEncryptedKey)
     */
    @Test
